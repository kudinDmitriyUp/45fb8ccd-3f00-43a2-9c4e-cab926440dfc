...
export const metadata: Metadata = {
  title: "MarketFlow - Digital Marketing Agency",
  description: "Data-driven marketing strategies that deliver results. Transform your brand with expert content, analytics, and creative campaigns.",
  keywords: "digital marketing agency, marketing strategy, content creation, social media management",
  metadataBase: new URL("https://marketflow.com"),
  alternates: {
    canonical: "https://marketflow.com"
  },
  openGraph: {
    title: "MarketFlow - Transform Your Brand's Digital Presence",
    description: "Expert marketing strategies that blend creativity with data analytics for measurable growth.",
    siteName: "MarketFlow",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766108011914-cqq8udnq.jpg",
        alt: "MarketFlow Marketing Services"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "MarketFlow Digital Marketing",
    description: "Data-driven strategies that turn insights into growth",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766108011914-cqq8udnq.jpg"]
  }
};
